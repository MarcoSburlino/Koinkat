...
The maintainer is responsible for clarifying and enforcing these
...
or harmful. The maintainer has the right to remove, edit, or reject
...
be reported to the maintainer, [@MarcoSburlino](https://github.com/MarcoSburlino).
All complaints will be reviewed and investigated promptly and fairly, and
the reporter's privacy will be respected.
